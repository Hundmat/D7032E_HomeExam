...
echo "Running Score Testing"
java -cp "$LIB_DIR/junit-platform-console-standalone-1.11.2.jar${SEP}$FULL_CP" org.junit.platform.console.ConsoleLauncher -c testing.ScoreTesting
